...
export class Terrain extends THREE.Mesh {
    ...
    createRocks(){
        ...
        for (let i=0; i< this.rockCount; i++){
            ...
            rockMesh.position.set(coords.x + 0.5,
            0,
            coords.y + 0.5
        );
    ...
    createBushes(){
        ...
        for (let i=0; i< this.bushCount; i++){
            ...
            bushMesh.position.set(coords.x + 0.5,
            radius,
            coords.y + 0.5
        );
